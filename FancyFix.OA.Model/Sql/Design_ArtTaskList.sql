...
-- ----------------------------
-- Table structure for Design_ArtTaskList
-- ----------------------------
...
'TABLE', N'Design_ArtTaskList', 
'COLUMN', N'Comment')) > 0) 
EXEC sp_updateextendedproperty @name = N'MS_Description', @value = N'评论'
, @level0type = 'SCHEMA', @level0name = N'dbo'
, @level1type = 'TABLE', @level1name = N'Design_ArtTaskList'
, @level2type = 'COLUMN', @level2name = N'Comment'
ELSE
EXEC sp_addextendedproperty @name = N'MS_Description', @value = N'评论'
, @level0type = 'SCHEMA', @level0name = N'dbo'
, @level1type = 'TABLE', @level1name = N'Design_ArtTaskList'
, @level2type = 'COLUMN', @level2name = N'Comment'
GO
...
-- ----------------------------
-- Indexes structure for table Design_ArtTaskList
-- ----------------------------

-- ----------------------------
-- Primary Key structure for table Design_ArtTaskList
-- ----------------------------
