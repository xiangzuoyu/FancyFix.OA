...
namespace FancyFix.Tools.Tool
{
    public class StringSimilarityTools
    {
        ...
        #endregion
        #region 构造函数
        public StringSimilarityTools(string str1, string str2)
        {
            this.LevenshteinDistanceInit(str1, str2);
        }
        public StringSimilarityTools()
        {
        }
        #endregion
        #region 算法实现
        ...
        public float Compute()
        {
            ...
            return float.Parse(this.Result.Rate);
        }
        /// <summary>
        /// 计算相似度
        /// </summary>
        /// <param name="str1">字符串1</param>
        /// <param name="str2">字符串2</param>
        public float Compute(string str1, string str2)
        {
            this.LevenshteinDistanceInit(str1, str2);
            return this.Compute();
        }
